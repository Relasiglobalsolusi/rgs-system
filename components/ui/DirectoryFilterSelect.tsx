...
export const directoryToolbarActionClass =
  "box-border inline-flex h-auto min-h-9 max-h-none shrink-0 items-center justify-center gap-2 whitespace-normal rounded-xl border border-primary/35 bg-card-tint-emerald px-3.5 py-1.5 text-sm font-bold text-primary-dark shadow-none hover:bg-[color-mix(in_srgb,var(--color-card-tint-emerald),var(--color-primary)_12%)] sm:h-9 sm:max-h-9 sm:whitespace-nowrap sm:py-0";

/** Download / report toolbar action — cyan like Open Billing. */
export const directoryToolbarDownloadClass =
  "box-border inline-flex h-auto min-h-9 max-h-none shrink-0 items-center justify-center gap-2 whitespace-normal rounded-xl border border-accent-cyan/40 bg-card-tint-cyan px-3.5 py-1.5 text-sm font-semibold text-accent-teal shadow-none hover:bg-[color-mix(in_srgb,var(--color-card-tint-cyan),var(--color-accent-cyan)_12%)] sm:h-9 sm:max-h-9 sm:whitespace-nowrap sm:py-0";
