...
export const en = {
  ...
  pages: {
    ...
    projects: {
      ...
      catchUp: {
        projectOngoing: "What Is This Project?",
        ongoing: "Ongoing",
        completed: "Completed",
        newProject: "New Project",
        projectOngoingHint:
    ...
    employees: {
      ...
      positionDialog: {
        ...
        createDescription:
          "Add a job position for a department and set the default modules for everyone in that position.",
        moduleAccess: "Default Module Access",
        moduleAccessHint:
          "Everyone in this position receives these modules, including people who already have a login. Adding a module here grants it to all of them. Extra modules already granted to one person stay on that person. Advance Cash can grant Petty Cash, Cards, or both. The system guide adds or removes one chapter per module you turn on or off, written for this position only. To give one person more or less access, use Users → Permissions.",
    ...
    users: {
      ...
      permissionsDescEmployee:
        "Access starts from this person's position default. Extra modules you grant here stay on this person if the position default later adds more modules.",
    ...
    billing: {
      ...
      vehiclePrepaidSpendHint:
        "This top-up is paid from the company bank and adds to the Card balance. Spends are recorded under Advance Cash → Cards.",
    ...
    financialReport: {
      ...
      reportSources: {
        ...
        prepaidOpenCardTopUp: "Top Up Prepaid Card",
    ...
    pettyCash: {
      ...
      tabOpenCards: "Prepaid Cards",
      prepaidCreate: "Add Card",
      prepaidCreateDesc:
        "Choose Vehicle Card or Prepaid Card, enter the number, and assign it now or leave it Standby.",
      ...
      cardManageDenied: "Only the owner can add or edit cards.",
      ...
      updateFailed: "Could not save this Card.",
      entriesEmpty: "No Card Activity In This Filter.",
      ...
      fileTypeInvalid: "Upload an image or PDF.",
      ...
      lostReturnLabel: "Return Lost Card {number}",
      topUpHolderLabel: "Top Up Petty Cash · {name}",
      topUpHolderNote: "Petty Cash top-up",
      transferOutLabel: "Transfer Petty Cash to {name}",
      transferInLabel: "Transfer Petty Cash from {name}",
      paidFromLabel: "Paid from {name}",
      cardKindRequired: "Choose Vehicle Card or Prepaid Card.",
      cardRequired: "Choose a Card.",
      cardNotFound: "Card not found.",
      standbyAssignOnly: "Only a Standby Card can be assigned.",
      returnBeforeReassign: "Return the Card to the list before assigning it again.",
      cardNotAssigned: "This Card is not assigned.",
      spendKindRequired: "Choose what this bill is for.",
      amountPaidRequired: "Enter the amount paid.",
      spendActiveOnly: "Spend is only allowed on an Active Card.",
      openCardOtherOnly: "Prepaid Cards can only record Other, with a note.",
      otherNoteRequired: "Add a note for this Other spend.",
      odometerRequired: "Enter the current odometer in kilometers.",
      litresRequired: "Enter how many litres were filled.",
      odometerWentBack: "The odometer cannot be lower than the last reading on this vehicle.",
      damagedActiveOnly: "Only an Active Card can be marked Damaged.",
      standbyAssignNow: "Choose a Standby Card to assign now.",
      replacementNotFound: "Replacement Card not found.",
      sameTypeRequired: "Choose a Card of the same type.",
      standbyRequired: "Choose a Standby Card.",
      vehicleCardNoVehicle: "This Vehicle Card has no vehicle.",
      openCardNoPic: "This Prepaid Card has no person in charge.",
      feeNegative: "Replacement fee cannot be negative.",
      bankForFee: "Choose the company bank account for the fee.",
      replacedDamagedOnly: "Card replaced is only available while the Card is Damaged.",
      feeExceedsLeftover: "The replacement fee is more than the leftover on this Card.",
      destinationRequired: "Choose the Card that receives the leftover.",
      destinationNotFound: "Destination Card not found.",
      destinationDifferent: "Choose a different Card, or continue on this Card.",
      cardNumberRetired: "That Card number is retired.",
      assignReplacementVehicle: "Assign the replacement Card to the vehicle first.",
      assignReplacementPic: "Assign the replacement Card to the person in charge first.",
      recoveryMethodRequired: "Choose how the leftover is recovered.",
      employeeCoverMethodRequired: "Choose how the employee will cover the leftover.",
      coveringEmployeeRequired: "Choose the employee who will cover the leftover.",
      returnBankRequired: "Choose the company bank account that received the return.",
      cardAlreadyRetired: "This Card is already retired.",
      payrollScheduleFailed: "Could not schedule Card recovery on Internal Payroll.",
      misuseCardRequired: "Choose a prepaid card.",
      misuseEmployeeRequired: "Choose the employee who misused the card.",
      misuseAmountRequired: "Enter how much was misused.",
      prepaidCardMissing: "Prepaid card not found.",
      writtenOffCompany: "Written off · company",
      writtenOffNamed: "Written off · {name}",
      transferToCardLabel: "Transfer to Card {number}",
      transferFromCardLabel: "Transfer from Card {number}",
      proof: "Bill / receipt",
