...
export const en = {
  ...
  pages: {
    ...
    pettyCash: {
      ...
      topUpOpenLabel: "Top Up Open Card {number}",
      ...
      cardKindRequired: "Choose Vehicle Card or Open Card.",
      ...
      openCardOtherOnly: "Open Cards can only record Other, with a note.",
      ...
      openCardNoPic: "This Open Card has no person in charge.",
