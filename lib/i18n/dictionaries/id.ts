...
export const id = {
  ...
  ui: {
    ...
    rejectionNotice: {
      ...
      fieldsStillMissing:
        "Masih kosong: {fields}. Lengkapi dulu sebelum melanjutkan."
    }
  },
  ...
  common: {
    ...
    labels: {
      ...
      noMatchingClients: "Tidak ada klien yang cocok dengan pencarian ini.",
    ...
    confirm: {
      ...
      unsavedTitle: "Menutup akan menghapus semua data",
      unsavedDescription: "Anda yakin?",
      exitWithoutSaving: "Yakin",
      keepEditing: "Tidak"
    },
    roles: {
      admin: "Admin",
  ...
  nav: {
    ...
    items: {
      ...
      BPJS: "BPJS",
      Sales: "Penjualan",
      "Petty Cash": "Kas Uang Muka",
      "Advance Cash": "Kas Uang Muka",
  ...
  status: {
    ...
    billingChip: {
      ...
      awaitingProgress1: "Menunggu",
      awaitingProgress2: "Progres",
      awaitingClientReview1: "Menunggu",
      awaitingClientReview2: "Persetujuan",
      taxInvoiceDue1: "Dokumen Pajak",
      taxInvoiceDue2: "Menunggu",
      taxInvoiceDone1: "Dokumen Pajak",
  ...
  pages: {
    dashboard: {
      ...
      mine: {
        ...
        description:
          "Hanya data Anda sendiri — tim, lokasi dan shift, kas Anda, dan upah Anda.",
        myWork: "Pekerjaan Saya",
        myMoney: "Keuangan Saya",
        teamLine: "{team} · {area}",
        noServiceArea: "Tanpa Area Layanan",
        noJobs: "Anda belum ditugaskan ke lokasi aktif.",
        noShiftWindow: "Jam shift belum diatur",
        backup: "Cadangan",
        covering: "Menggantikan {name}",
        earnedSoFar: "Upah Periode Ini",
        earnedHint:
          "{days} shift dibayar sejauh ini · {period} · perkiraan sampai payroll dibuat",
        earnedExemptHint: "Gaji bulanan tetap · {period}",
        pettyCash: "Kas Kecil Saya",
        pettyCashHint: "Kas Anda. Hanya Anda yang bisa memakainya.",
        pettyCashNegative:
          "Anda memakai uang pribadi. Ini diganti pada pengisian berikutnya.",
        bpjsPaid: "BPJS Yang Saya Bayar",
        bpjsHint: "Iuran Anda pada setiap periode payroll yang sudah ditutup.",
        bpjsHeld: "{amount} ditahan dari iuran yang belum terbayar.",
        thr: "THR",
        thrPaid: "Dibayar untuk {year}",
        thrUpcoming: "Jatuh sekitar {date}",
        openPettyCash: "Buka Kas Kecil",
        openCards: "Buka Kartu",
        openPayslips: "Slip Gaji Saya"
      },
    ...
    projects: {
      ...
      filterClient: "Klien",
      filterAllClients: "Semua Klien",
      rgsInternalClient: "RGS Internal",
      rgsInternalHint:
        "Ini pekerjaan kita sendiri. Tidak ada klien yang ditagih, tidak ada demo, dan tidak ada penagihan. Karyawan tetap CICO dan kirim laporan progres. Inventaris tetap bisa dialokasikan supaya biayanya terlihat.",
      rgsInternalLocationHint:
        "Tidak ada kontrak klien. Peta default ke Kantor Pusat. Pilih area layanan dan jenis pekerjaan seperti biasa — shift hanya muncul jika jenis pekerjaan itu memakai shift.",
      ...
      isDemo: "Apakah Ini Demo?",
      isDemoHint: "Proyek demo selalu satu kali.",
      isDemoFree: "Apakah Demo Ini Gratis?",
      isDemoFreeHint:
        "Demo gratis melewati penagihan, pajak, harga kontrak, dan faktur.",
      ...
      chargeVatHint:
        "Ya menambah Pajak Pertambahan Nilai dan faktur pajak. Kontrak pemerintah tetap menerbitkan faktur pajak, tetapi hanya DPP yang dibayar kepada kami.",
      chargePph: "Kenakan PPh?",
      chargePphHint:
        "Ya menambah pajak penghasilan (potong atau final). PPN dan PPh bisa dikenakan bersama.",
      pphKind: "Jenis Pajak Penghasilan",
      governmentContract: "Kontrak Pemerintah",
      governmentContractHint:
        "Uang Masuk Hanya DPP. Instansi Yang Membayar Pajak. Kami Tetap Menerbitkan Faktur Pajak. Relasi Tidak Menyetor PPN Itu, Dan Tidak Ada Pajak Yang Keluar Dari Rekening Kami.",
      ...
      catchUp: {
        projectOngoing: "Proyek Ini Apa?",
        ongoing: "Sudah Berjalan",
        completed: "Selesai",
        newProject: "Proyek Baru",
        projectOngoingHint:
          "Pilih ini dulu. Proyek Baru untuk pekerjaan yang dimulai di ERP ini. Sudah Berjalan untuk yang dimulai sebelum ERP ini dan masih jalan. Selesai untuk pekerjaan sekali yang sudah ditutup, seperti General Cleaning atau Facade.",
        invoice: "Invoice",
        invoiceHint:
          "ERP membuat invoice periode ini. Setelah disimpan, invoice bisa diunduh dari halaman periode.",
        taxInvoice: "Faktur Pajak",
        taxInvoiceHint:
          "Wajib untuk menyimpan periode ini. Unggah faktur pajak di sini.",
        paymentReceived: "Pembayaran Diterima",
        paymentHint:
          "Biarkan tidak dicentang jika klien belum bayar. Bukti bisa ditambah nanti.",
        paymentRequiredHint:
          "Pekerjaan selesai wajib diisi jumlah diterima dan bukti pembayaran.",
        ...
        clientPaysHint:
          "Disarankan dari tarif bulanan untuk tanggal ini. Jumlah lain masih bisa diketik.",
        savePeriod: "Simpan Periode",
        saveJob: "Selesaikan Pekerjaan",
        failed: "Tidak dapat menyimpan periode ini.",
        periodAlreadyExists: "Periode ini sudah ada. Silakan periksa kembali.",
        periodAlreadyCompleted: "Periode ini sudah selesai dicatat.",
        periodsDone: "Periode Yang Sudah Selesai",
        periodsDoneHint:
          "Harus sama dengan setiap siklus tagihan yang dimulai sebelum books-open. Create ditolak jika angkanya tidak cocok.",
        paidDate: "Tanggal Dibayar",
        receivingBank: "Bank Penerima",
        receivingBankHint: "Rekening perusahaan yang menerima pembayaran ini.",
        staffTotal: "Total Biaya Staf",
        staffTotalHint:
          "Satu total untuk periode ini. Unggah PDF gaji yang sudah dikompilasi. Tidak ada CICO untuk riwayat ini.",
        staffPdf: "PDF Gaji Terkompilasi",
        materialTotal: "Total Biaya Material",
        materialTotalHint:
          "Satu total untuk periode ini. Unggah invoice pemasok. Ini tidak mengubah stok gudang.",
        supplierInvoices: "Invoice Pemasok",
        hubTitle: "Periode Catch-Up",
        hubHint:
          "Catat setiap periode yang sudah selesai di sini. Periode tertutup tetap bisa dilihat dan bukan penagihan live.",
        backToProject: "Kembali Ke Proyek",
        backToHub: "Kembali Ke Periode Catch-Up",
        recorded: "Tercatat",
        needsCapture: "Perlu Dicatat",
        viewPeriod: "Lihat Periode",
        openPeriod: "Buka Periode",
        readOnlyHint:
          "Periode catch-up ini sudah tercatat. Tetap masuk laporan pendapatan dan biaya proyek ini, bukan penagihan live.",
        pageHint:
          "Isi berapa yang dibayar klien, unggah faktur pajak, lalu tambah bukti bayar dan dokumen biaya jika ada. Invoice dibuat saat Anda menyimpan.",
        openHub: "Periode Catch-Up",
        openHub1: "Periode",
        openHub2: "Catch-Up"
      },
      ...
      visitPlanHintInternal:
        "Atur jadwal kunjungan pada satu proyek — misalnya dua atau empat kali setahun — agar tidak membuat pekerjaan yang sama dua kali.",
      multipleVisitProject: "Apakah Ini Proyek Kunjungan Berulang?",
      multipleVisitHint:
        "Ya = satu pekerjaan Landscaping atau Security dengan beberapa kunjungan dalam setahun. Tidak = satu kunjungan saja.",
      visitN: "Kunjungan {n}",
      ...
      submitForApproval: {
        ...
        visitWindowNotStarted:
          "Ajukan Persetujuan hanya setelah jendela kunjungan ini dimulai.",
      ...
      timelineFields: {
        ...
        durationMonths: "Perkiraan Durasi",
        durationDays: "Perkiraan Durasi",
        durationActual: "Durasi",
        daysUnit: "hari",
        ...
        projectFinish: "Tanggal Selesai Proyek",
      ...
      paymentPlan: {
        ...
        eachPaymentPercentRemaining:
          "Setiap Pembayaran (% dari Sisa Setelah Uang Muka)",
      ...
      downPayment: {
        label: "Wajib Uang Muka",
        hint:
          "Invoice uang muka terpisah, dengan faktur pajak dan bukti pembayaran sendiri, dapat diterbitkan segera setelah pekerjaan ada. Sisa ditagih hanya setelah Anda mengirim laporan progres, klien menyetujui, lalu invoice sisa keluar — alur yang sama dengan pekerjaan tanpa uang muka.",
        percentLabel: "Persen Uang Muka",
        percentHint: "Persen dari harga kontrak di luar pajak (1–99).",
        invoiceLabel: "Uang Muka",
        invoiceLabelForProject: "Uang Muka untuk {project}",
        invoiceLabelWithPercent: "Uang Muka {percent}% untuk {project}",
        issueInvoice: "Terbitkan Uang Muka"
      },
      ...
      periodPage: {
        ...
        pendingApprovalNoPortalWhy:
          "Klien ini tidak punya login portal. Head Office mencatat Disetujui atau Direvisi di sini setelah mengirim laporan di luar ERP. Invoice penjualan diterbitkan hanya setelah catatan Head Office itu.",
        ...
        reportsEmptyCatchUp:
          "Siklus ini ditagih sebelum ruang kerja ini dipakai, jadi kemajuan lapangan tidak dicatat di sini. Tidak ada laporan kemajuan untuk tanggal ini.",
        historicalRecordWhy:
          "Catat dokumen tagihan untuk siklus ini. Invoice dibuat di sini. Faktur pajak wajib untuk menyimpan.",
      ...
      finish: {
        ...
        lastDayHint:
          "Pilih hari kerja terakhir. Tanggal dibulatkan ke akhir periode penagihan penuh (akhir bulan, atau hari akhir siklus seperti tanggal 15). Kru tetap di lokasi sampai tanggal itu, lalu tagihan terakhir direkonsiliasi keesokan harinya.",
        confirmEndContract:
        ...
        catchUpBeforeClose:
          "Catat setiap periode catch-up historis sebelum mengakhiri kontrak ini.",
    ...
    clients: {
      ...
      downloadSystemGuide: "Unduh Panduan Sistem Klien",
      ...
      downloadLoginIds: "Unduh ID Login",
      loginIdExport: {
        reportTitle: "ID Login Klien",
        generatedOn: "Dibuat {date}",
        colName: "Nama Klien",
        colLoginId: "ID Login",
        fileName: "ID-Login-Klien.pdf",
        empty: "Tidak ada klien untuk dicantumkan."
      },
      ...
      systemGuideFileName: "Panduan-Sistem-Klien.pdf",
      deleted: "Dihapus",
      active: "Aktif",
      ...
      form: {
        ...
        portalAccessDesc:
          "Pilih apakah klien ini akan masuk ke ERP. Klien kontrak rutin biasanya ya. Klien General atau Façade sekali jalan biasanya tidak.",
        portalAccessDescIndividual:
          "Pilih apakah orang ini akan masuk ke ERP. Pekerjaan sekali jalan biasanya tidak perlu portal.",
    ...
    vendors: {
      ...
      form: {
        ...
        bankAccountsDesc:
          "Tujuan pembayaran ke vendor ini. Tambahkan setiap rekening yang mereka pakai.",
        bankName: "Nama Bank",
        accountNumber: "Nomor Rekening",
        accountHolder: "Nama Pemilik Rekening",
        accountLabel: "Label",
        accountLabelPlaceholder: "mis. BCA Operasional",
        addBankAccount: "Tambah Rekening",
        removeBankAccount: "Hapus",
        bankAccountRequired: "Tambahkan minimal satu rekening vendor agar pengeluaran tahu tujuan pembayaran."
      }
    },
    employees: {
      title: "Karyawan",
      ...
      downloadLoginIds: "Unduh ID Login",
      loginIdExport: {
        reportTitle: "ID Login Karyawan",
        generatedOn: "Dibuat {date}",
        colName: "Nama Karyawan",
        colLoginId: "ID Login",
        fileName: "ID-Login-Karyawan.pdf",
        empty: "Tidak ada karyawan untuk dicantumkan."
      },
      ...
      errors: {
        ...
        shortfallChoiceRequired:
          "Pilih apakah karyawan membayar sisa saldo.",
        shortfallBankRequired:
          "Pilih rekening perusahaan yang menerima sisa saldo.",
        shortfallPaidAtRequired:
          "Masukkan tanggal rekening perusahaan menerima sisa saldo.",
        shortfallProofRequired:
          "Unggah bukti pembayaran. Resign tidak dapat diselesaikan tanpa bukti."
      },
      resign: "Resign",
      ...
      resignBalanceOwed: "Saldo terutang kepada perusahaan: {amount}.",
      resignDepositAfterDeduction: "Deposit setelah dipotong: {amount}.",
      resignShortfall: "Kekurangan setelah deposit: {amount}.",
      resignPaysRest: "Apakah karyawan membayar sisanya?",
      resignPaysRestYes: "Ya, karyawan sudah membayar sisanya",
      resignPaysRestNo: "Tidak, beban kekurangannya ke proyek terakhir",
      resignPaysRestBank: "Rekening Perusahaan Yang Menerima Uang",
      resignPaysRestPaidAt: "Tanggal Dibayar",
      resignPaysRestPaidAtHint:
        "Tanggal rekening perusahaan menerima sisa saldo.",
      resignPaysRestProof: "Bukti Pembayaran",
      resignPaysRestProofHint:
        "Unggah bukti pembayaran. Resign tidak dapat diselesaikan tanpa bukti.",
      resignPaysRestHint:
        "Ya mencatat pendapatan Employee Paying Balance Due pada tanggal dibayar. Unggah bukti pembayaran. Tidak membebankan kekurangan ke proyek terakhir.",
      ...
      positionDialog: {
        ...
        createDescription:
          "Tambahkan jabatan untuk sebuah departemen dan atur modul bawaan untuk semua orang dengan jabatan itu.",
        moduleAccess: "Akses Modul Bawaan",
        moduleAccessHint:
          "Semua orang dengan jabatan ini menerima modul ini, termasuk yang sudah punya login. Menambah modul di sini memberikannya ke semuanya. Modul tambahan yang sudah diberikan ke satu orang tetap ada pada orang itu. Kas Uang Muka bisa memberi Kas Kecil, Kartu, atau keduanya. Panduan sistem menambah atau menghapus satu bab per modul yang Anda hidupkan atau matikan, ditulis hanya untuk jabatan ini. Untuk memberi satu orang akses lebih atau kurang, gunakan Pengguna → Izin.",
      ...
      form: {
        ...
        payrollRun: "Periode Payroll",
        payrollRunHint:
          "Pilih siklus gaji karyawan ini. Periode ini menentukan hari absensi dan potongan yang masuk ke payroll.",
        payrollRunProject: "Tanggal 16 Sampai 15",
        payrollRunHeadOffice: "Tanggal 26 Sampai 25",
        payrollRunLockedHint:
          "Jabatan ini masuk ke periode payroll Head Office tanggal 26–25.",
    ...
    users: {
      ...
      permissionsDescEmployee:
        "Akses dimulai dari modul bawaan jabatan orang ini. Modul tambahan yang Anda berikan di sini tetap ada pada orang itu jika bawaan jabatan nanti menambah modul lain.",
    ...
    billing: {
      ...
      purchaseDescription:
        "Catat setiap pengeluaran perusahaan di sini: tagihan pemasok, jasa, isi ulang Kas Kecil, dan isi ulang kartu prabayar kendaraan.",
      ...
      settlementsOpenPurchases: "Buka Beban",
      ...
      expenseReportHint: "Pengeluaran yang sudah dibayar menurut tanggal bayar untuk periode yang dipilih.",
      expenseReportHintGrouped:
        "Pendapatan dan pengeluaran yang sudah dibayar menurut tanggal bayar, dikelompokkan per subkategori dan proyek. Pajak atas pendapatan tercantum di bawah setiap pembayaran. Laba bersih adalah DPP dikurangi pengeluaran.",
      expenseReportDate: "Tanggal",
      expenseReportKind: "Jenis",
      expenseReportDetail: "Rincian",
      expenseReportIncome: "Pendapatan",
      expenseReportExpense: "Pengeluaran",
      expenseReportPpn: "PPN",
      expenseReportPph: "PPh",
      expenseReportGross: "Total Tagihan",
      expenseReportProjectNet: "Laba Bersih Proyek",
      expenseReportGroupNet: "Laba Bersih Subkategori",
      expenseReportIncomeTotal: "Pendapatan (DPP)",
      expenseReportExpenseTotal: "Pengeluaran",
      expenseReportCompanyNet: "Laba Bersih Perusahaan",
      expenseReportUnassigned: "Kantor Pusat / Belum Ditugaskan",
      expenseReportStaffCost: "Biaya Staf",
      expenseReportMaterialCost: "Biaya Material",
      expenseReportReference: "Faktur",
      expenseReportStatus: "Status",
      expenseReportAmount: "Jumlah",
      expenseReportTotal: "Total",
      expenseReportEmpty: "Tidak ada pengeluaran yang dibayar pada periode ini.",
      expenseReportEmptyGrouped: "Tidak ada pendapatan atau pengeluaran yang dibayar pada periode ini.",
      expenseReportPeriodMonth: "{month} {year}",
      expenseReportPeriodDay: "{day} {month} {year}",
      expenseReportPeriodYear: "{year}",
      expenseReportPayFrom: "Dibayar Dari",
      expenseReportPayTo: "Dibayar Ke",
      expenseReportBanks: "Dari {from} · Ke {to}",
      apReportDownload: "Unduh Laporan Utang Usaha",
      apReportTitle: "Laporan Utang Usaha",
      apReportHint:
        "Tagihan pemasok belum lunas yang jatuh tempo pada periode ini, plus tagihan terlambat dari bulan sebelumnya, dikelompokkan menurut bulan jatuh tempo.",
      apReportDueDate: "Jatuh Tempo",
      apReportEmpty: "Tidak ada tagihan jatuh tempo pada periode ini, dan tidak ada yang terlambat dari bulan sebelumnya.",
      apReportMonthGroup: "Jatuh Tempo {month}",
      apReportMonthTotal: "Total Bulan",
      apReportTotal: "Total Utang",
      apBcaDownload: "Unduh Transfer Massal",
      apBcaTitle: "Transfer Massal",
      apBcaDesc:
        "Centang tagihan belum lunas. Tagihan tidak ditandai lunas. Pilih bank pengirim di bawah.",
      apBcaBank: "Bank Pengirim",
      apBcaBankHint: "File transfer massal dibuat untuk bank ini.",
      apBcaBankBca: "BCA",
      apBcaEmpty: "Tidak ada tagihan belum lunas.",
      apBcaConfirm: "Unduh Transfer Massal",
      apBcaSelectRequired: "Centang setidaknya satu tagihan.",
      ...
      takeCash: "Ambil Tunai",
      takeCashTitle: "Ambil Tunai",
      takeCashDesc:
        "Potong rekening perusahaan dan simpan uang tunainya. Lokasi simpan tidak dicatat. Memakainya nanti adalah beban.",
      takeCashAmount: "Jumlah",
      takeCashAmountRequired: "Masukkan jumlah tunai yang diambil.",
      takeCashDate: "Tanggal Diambil",
      takeCashDateRequired: "Masukkan tanggal uang keluar dari bank.",
      takeCashBank: "Diambil Dari Bank",
      takeCashBankHint: "Rekening perusahaan tempat tunai ini ditarik.",
      takeCashNote: "Catatan",
      takeCashNotePlaceholder: "Opsional. Misalnya ATM atau teller.",
      takeCashNoteHint: "Opsional. Lokasi simpan tunai tidak dicatat.",
      takeCashBalance: "Kas tunai saat ini {amount}.",
      takeCashConfirm: "Ambil Tunai",
      takeCashPending: "Menyimpan…",
      takeCashFailed: "Gagal mengambil tunai.",
      purchasePaymentMethod: "Cara Bayar",
      purchasePaymentMethodBank: "Bank",
      purchasePaymentMethodCash: "Tunai",
      purchasePaymentMethodBankHint:
        "Bayar dari rekening bank perusahaan.",
      purchasePaymentMethodCashHint:
        "Bayar dari Kas Tunai. Saldo saat ini {amount}.",
      purchaseCashNotAllowed:
        "Pengeluaran ini tidak bisa dibayar dari Kas Tunai. Gunakan rekening perusahaan.",
      purchaseCashInsufficient:
        "Kas tunai tidak cukup. Ambil tunai dari rekening perusahaan dulu.",
      purchasePayFromCash: "Kas Tunai",
      purchaseUploadTitle: "Tambah Pengeluaran",
      purchaseUploadDesc:
        "Catat tagihan pemasok, jasa, isi ulang Kas Kecil, atau isi ulang kartu prabayar kendaraan. Lampirkan tagihan bila ini faktur pemasok.",
      ...
      purchaseCategoryAdvanceCash: "Kas Kecil",
      advanceCashKind: "Jenis Kas Uang Muka",
      advanceCashKindPetty: "Kas Kecil",
      advanceCashKindPrepaid: "Kartu Prabayar",
      advanceCashPettyHint:
        "Pilih karyawan yang menerima uang ini. Saldo Kas Kecil karyawan itu bertambah. Kartu diisi ulang lewat Kartu Prabayar.",
      ...
      pettyCashHoldersOnly:
        "Uang muka kas kecil hanya untuk pemegang Kas Kecil yang sudah ada.",
      advanceCashPrepaidHint:
        "Isi ulang Kartu Kendaraan atau Kartu Prabayar di Kartu Prabayar. Pengeluaran BBM, tol, dan parkir dicatat di Kas Uang Muka → Kartu.",
      ...
      prepaidCardHint:
        "Isi ulang ini menambah saldo kartu. Pakai Kartu Prabayar untuk Kartu Kendaraan dan Kartu Prabayar Kantor Pusat.",
      purchaseCategoryOpenCard: "Kartu Prabayar",
      ...
      purchaseCategoryHint:
        "Produk menjadi stok gudang. Kendaraan dibeli di dalam negeri dan dicatat di Inventaris → Kendaraan. Isi ulang Kartu Kendaraan atau Kartu Prabayar di Kartu Prabayar. Jasa, Kas Kecil, Pemerintah, Pinjaman, dan Pembayaran Karyawan bukan stok.",
      ...
      employeePaymentCashAdvance: "Kasbon",
      employeePaymentDepartment: "Departemen",
      employeePaymentDepartmentAll: "Semua Departemen",
      employeePaymentEmployee: "Karyawan",
      employeePaymentEmployeeSearch: "Cari karyawan…",
      employeePaymentEmployeeRequired: "Pilih karyawan yang menerima kasbon ini.",
      employeePaymentKindRequired: "Pilih Internal Payroll, THR, atau Kasbon.",
      employeePaymentPeriod: "Bulan Payroll",
      employeePaymentPeriodHint:
        "Kasbon ini dipotong dari Internal Payroll pada bulan ini.",
      employeePaymentAutoPeriod:
        "Dipotong dari Internal Payroll berikutnya (gaji terdekat). Anda tidak memilih bulannya.",
      employeePaymentAutoPeriodHint:
        "Kalau kasbon diambil tanggal 1 atau tanggal 24, potongan tetap pada gaji terdekat. Potongan payroll lain memakai aturan yang sama.",
      payFromAccount: "Dibayar Dari",
      payFromAccountHint: "Rekening bank perusahaan tempat uang keluar.",
      payToAccount: "Bank, Nama Rekening, Dan Nomor Rekening",
      payToAccountHint:
        "Pilih bank, nama rekening, dan nomor rekening vendor yang menerima pembayaran ini.",
      payToAccountRequired:
        "Pilih bank, nama rekening, dan nomor rekening vendor tujuan pembayaran.",
      payToAccountEmpty:
        "Vendor ini belum punya rekening. Tambahkan bank, nama rekening, dan nomor rekening di data vendor dulu.",
      governmentBpjsVaKesehatan: "Virtual Account BPJS Kesehatan",
      governmentBpjsVaKetenagakerjaan: "Virtual Account BPJS Ketenagakerjaan",
      loanSource: "Sumber Pinjaman",
      loanSourceBank: "Pinjaman Bank",
      loanSourceShareholder: "Pinjaman Pribadi",
      loanSourceHint:
      ...
      loanChargesInterest: "Apakah Kreditur Membebankan Bunga?",
      ...
      loanShareholderName: "Nama Kreditur",
      ...
      bankLoanKindTermHint:
        "Ini Pinjaman Berjangka (Kredit Angsuran). Pilih Flat, Efektif, atau Anuitas. Anuitas sama dengan rumus anuitas OCBC / BCA / Mandiri.",
      loanCalculationMethod: "Metode Perhitungan Pinjaman",
      loanCalculationMethodFlat: "Flat",
      loanCalculationMethodEffective: "Efektif",
      loanCalculationMethodAnnuity: "Anuitas",
      loanCalculationMethodHint:
        "Flat: total bunga = pokok × suku bunga tahunan × tahun, lalu dibagi rata. Efektif: bunga atas sisa pokok (angsuran pertama ditampilkan). Anuitas: angsuran tetap M = P × r × (1+r)^n / ((1+r)^n − 1).",
      loanCalculationMethodFlatHint:
        "Total bunga = pokok × suku bunga tahunan × tahun, lalu dibagi rata sepanjang tenor.",
      loanCalculationMethodEffectiveHint:
        "Bunga dihitung atas sisa pokok. Angsuran pertama yang ditampilkan adalah pokok ÷ bulan plus bunga atas pokok penuh.",
      loanCalculationMethodAnnuityHint:
        "Angsuran tetap M = P × r × (1+r)^n / ((1+r)^n − 1), dengan r suku bunga bulanan. Ini sama dengan anuitas OCBC / BCA / Mandiri.",
      loanCalculationMethodRequired: "Pilih Flat, Efektif, atau Anuitas.",
      loanCommitmentFee: "Apakah pinjaman ini punya commitment fee?",
      loanCommitmentFeeHint:
        "Beberapa fasilitas standby membebankan biaya per tahun atas plafon yang belum dipakai.",
      loanCommitmentFeeRate: "Tarif Commitment Fee % Per Tahun",
      loanCommitmentFeeRateHint:
        "Dikenakan pada plafon yang belum dipakai. Biaya = unused × tarif per tahun × hari / 360. Seperempat tahun 90 hari pada 0,5% atas Rp 6.000.000.000 unused adalah Rp 7.500.000.",
      loanCommitmentFeePreview:
        "Jika sisa plafon tetap {unused} selama {days} hari: {amount}.",
      loanCommitmentFeeRateRequired: "Isi tarif commitment fee.",
      bankLoanAnuitasHint:
      ...
      vehicleLeasePaymentMustBeFull:
        "Cicilan sewa harus dibayar penuh. Masukkan jumlah cicilan bulanan.",
      ...
      vehicleExpenseKind: "Untuk Apa Beban Kendaraan Ini",
      vehicleExpenseKindPurchase: "Pembelian Kendaraan",
      vehicleExpenseKindFuel: "Bahan Bakar",
      vehicleExpenseKindServicing: "Servis",
      ...
      vehiclePrepaidSpendHint:
        "Isi ulang ini dibayar dari rekening perusahaan dan menambah saldo kartu prabayar. Pengeluaran BBM, tol, dan parkir dicatat di Kas Uang Muka → Kartu.",
      vehiclePrepaidCardRequired: "Pilih kartu prabayar yang akan diisi ulang.",
      payFromPending: "Belum dipilih — pilih rekening perusahaan saat membayar.",
      payToPending: "Belum dipilih — pilih rekening vendor saat membayar.",
      ...
      handlingAllInCharge: "Biaya All-In",
      handlingAllInHint:
        "Biaya tunggal ini sudah termasuk bea dan handling.",
      handlingHasTaxInvoice: "Apakah Biaya Ini Memiliki Faktur Pajak?",
      handlingDetailsNowTitle: "Rincian Handling",
      handlingDetailsNowHint:
        "Isi sekarang jika datanya sudah ada. Bisa juga ditambahkan nanti.",
      handlingOptionalFile: "Berkas Pendukung (Opsional)",
      handlingLaterWithDuties: "Bayar handling nanti bersama bea impor",
      handlingLaterWithDutiesHint:
        "Petugas handling menagih biaya handling bersama bea impor. Isi vendor, biaya, dan invoice handling saat bea dibayar.",
      handlingDueWithDuties:
        "Handling akan dicatat saat bea impor dibayar.",
      handlingPaidAtArrivalHint:
        "Handling dibayar saat barang tiba, bersama bea impor. Biaya gudang baru muncul saat itu. Selisih kurs booking dan bank dibukukan ke Head Office sebagai laba atau beban selisih kurs untuk produk tersebut.",
      ...
      purchaseMarkPaidDesc:
        "Masukkan tanggal uang keluar dari bank, pilih bank, dan unggah bukti. Ini menutup AP.",
      purchaseMarkPaidHint:
        "Tanggal bayar adalah hari uang keluar dari rekening. Unduhan Excel tidak menandai tagihan lunas.",
      ...
      noTaxPending: "Tidak ada dokumen pajak menunggu",
      noTaxPendingDesc:
        "Saat Anda menerbitkan invoice untuk proyek bertanda dengan pajak, item muncul di sini hingga dokumen pajak diunggah.",
      noTaxCompleted: "Tidak ada item selesai",
      noTaxCompletedDesc: "Dokumen pajak yang sudah diunggah akan muncul di sini.",
      taxInvoiceDue: "Dokumen Pajak Menunggu",
      taxInvoiceSent: "Dokumen Pajak Terunggah",
      markTaxDone: "Unggah Dokumen Pajak",
      ...
      markTaxSentFailed: "Gagal mengunggah dokumen pajak.",
      ...
      paymentReceivedDialogDesc:
        "Masukkan tanggal klien benar-benar membayar, unggah bukti, lalu konfirmasi. Membersihkan invoice jatuh tempo; proyek tetap aktif untuk bulan berikutnya.",
      paymentReceivedDialogDescHistory:
        "Masukkan tanggal klien benar-benar membayar, unggah bukti, lalu konfirmasi. Saat semua invoice lunas, proyek pindah ke Selesai.",
      paidAtRequired: "Masukkan tanggal uang keluar dari bank.",
      paidAt: "Tanggal Dibayar",
      paidAtHint: "Tanggal uang keluar dari bank atau laci tunai.",
      clientPaidAtRequired: "Masukkan tanggal klien benar-benar membayar.",
      taxInvoiceIssuedAt: "Tanggal Terbit Faktur Pajak",
      taxInvoiceIssuedAtHint: "Tanggal terbit pada faktur, bukan tanggal unggah.",
      taxInvoiceIssuedAtRequired: "Masukkan tanggal terbit faktur pajak.",
      returnCash: "Kembalikan Tunai",
      returnCashTitle: "Kembalikan Tunai Ke Bank",
      returnCashDesc:
        "Kas tunai berkurang dan rekening perusahaan yang dipilih bertambah. Ini bukan beban.",
      returnCashAmount: "Jumlah",
      returnCashAmountRequired: "Masukkan jumlah tunai yang dikembalikan.",
      returnCashDate: "Tanggal Dikembalikan",
      returnCashDateRequired: "Masukkan tanggal tunai kembali ke bank.",
      returnCashBank: "Dikembalikan Ke Bank",
      returnCashConfirm: "Kembalikan Tunai",
      returnCashInsufficient: "Kas tunai tidak cukup untuk pengembalian ini.",
      moduleNotRelevant: "Modul ini tidak relevan untuk Anda.",
      ...
      withholdingSlip: "Bukti Potong",
      withholdingSlipHint:
        "Bukti Potong PPh. Unggah Ini Jika Pajak Penghasilan Dipotong Bersama PPN.",
      chooseWithholdingSlip:
        "Pilih gambar atau PDF bukti potong.",
      withholdingSlipUploadTitle: "Unggah Bukti Potong",
      withholdingSlipUploadDesc:
        "Unggah Bukti Potong, lalu konfirmasi bahwa isinya cocok dengan dokumen.",
      chooseTaxInvoiceDocument:
        "Pilih gambar atau PDF faktur pajak.",
      taxDocumentUploadTitle: "Unggah Dokumen Pajak",
      taxDocumentUploadDesc:
        "Unggah dokumen pajak, lalu konfirmasi. ID Billing, bukti setor, atau bukti pendukung lain.",
      taxDocumentUploadFailed: "Gagal mengunggah dokumen pajak.",
      chooseTaxDocument:
        "Pilih gambar atau PDF dokumen pajak.",
      paymentVerifyHint:
      ...
      deleteIssuedInvoiceConfirm:
        "Batalkan “{label}”? Periode kembali ke Rekonsiliasi atau Kirim untuk Persetujuan agar tagihan bisa diperbaiki. Jumlah tetap. File invoice dan bukti pembayaran dihapus.",
      deletePeriodConfirm:
        "Batalkan “{label}”? Periode kembali ke Rekonsiliasi atau Kirim untuk Persetujuan. Jumlah tetap. File tagihan ini dihapus.",
      ...
      parking: {
        ...
        creditHint:
          "Bulan yang Anda pilih adalah periode parkir untuk uang ini ({period} {year}). Catat tanggal bank mengkreditkannya — sering dua atau tiga hari kemudian.",
        creditedAt: "Tanggal Kredit Bank",
        creditedAtHint:
          "Tanggal bank membukukan pendapatan parkir ini, bukan bulan parkirnya.",
        receivingBank: "Bank Penerima",
      ...
      payrollMgmt: {
        ...
        generatePdf: "Buat Excel",
        sendToClient: "Kirim Ke Klien",
        ...
        wagesPaidNeedsLock:
          "Buat dan kunci lembar upah terlebih dahulu. Upah baru masuk laporan keuangan setelah periode ini dikunci.",
      ...
      reconcileTaxInvoiceMissing:
        "Periode ini belum punya faktur pajak. Setiap invoice klien butuh faktur pajak — lampirkan sebelum invoice keluar.",
      ...
      downloadPdf: "PDF",
      needsDocuments: "Perlu Dokumen",
      recordPeriod: "Catat Periode",
      ...
      progressReportsRequiredBeforeReview:
        "Kirim setidaknya satu laporan progres sebelum mengirim ini ke klien.",
      remainderNeedsProgressReview:
        "Invoice sisa diterbitkan setelah Anda mengirim laporan progres dan klien menyetujui — alur yang sama dengan pekerjaan tanpa uang muka.",
    ...
    taxRates: {
      ...
      button: "Tarif Pajak",
      heading: "Tarif Pajak",
      hint: "Setiap pajak di ERP membaca tabel ini pada tanggal berlakunya. Persen baru hanya berlaku dari tanggal itu ke depan. Bulan sebelumnya tetap memakai tarif lama.",
      addType: "Tambah Jenis Pajak",
      addTypeTitle: "Tambah Jenis Pajak",
      addTypeDesc: "Jenis ini lalu muncul di tempat kita membebankan pajak, dengan persen yang Anda tetapkan.",
      addRate: "Sesuaikan Tarif",
      addRateTitle: "Sesuaikan Tarif · {name}",
      addRateDesc: "Tetapkan persen dan tanggal mulai berlaku. Dokumen sebelum tanggal itu tetap memakai tarif sebelumnya.",
      saveType: "Simpan Jenis Pajak",
      saveRate: "Simpan Tarif",
      saveFailed: "Tidak dapat menyimpan tarif pajak.",
      columnType: "Jenis Pajak",
      columnRate: "Tarif",
      columnFrom: "Berlaku Dari",
      columnApplies: "Dipakai Untuk",
      appliesClient: "Tagihan Klien",
      appliesCorporate: "PPh Badan",
      appliesHint: "Tagihan Klien muncul di pekerjaan dan invoice. PPh Badan adalah baris pajak penghasilan pada laba rugi.",
      typeName: "Nama Jenis Pajak",
      typeNamePlaceholder: "mis. Pajak Jasa Daerah",
      effectiveFrom: "Berlaku Dari",
      effectiveFromHint: "Tanggal pertama persen ini berlaku. Pilih hari ini kecuali aturannya sudah berubah di tanggal sebelumnya.",
      note: "Catatan",
      history: "Riwayat Tarif",
      noRate: "Belum Ada Tarif",
      noRateHint: "Tambah tarif dengan tanggal berlaku sebelum jenis ini bisa dipilih di pekerjaan.",
      fromDate: "Dari {date}",
      missing: "Tambah tarif pajak ini di Tarif Pajak terlebih dahulu.",
      currentRate: "Tarif saat ini {percent} dari Tarif Pajak.",
      followsTable: "Persen diambil dari Tarif Pajak pada tanggal dokumen. Ubah di sana, bukan di formulir ini.",
    },
    vat: {
      period: "Periode",
      rateHint:
      ...
      outputTotalYearHint: "PPN Keluaran untuk seluruh tahun",
      ...
      creditBroughtForwardHint:
        "Sisa PPN masukan dari bulan sebelumnya setelah bulan itu disetor. Tidak pernah minus.",
      creditBroughtForwardYearHint:
        "Sisa PPN masukan di akhir tahun setelah setiap bulan disetor. Dibawa ke tahun berikutnya. Tidak pernah minus.",
      taxReportDownload: "Unduh Laporan Pajak",
      taxInvoiceReportDownload: "Unduh Faktur Pajak Tertunda",
      taxInvoiceReportTitle: "Laporan Faktur Pajak Tertunda",
      taxInvoiceReportHint:
        "Dokumen pajak yang masih harus diterbitkan atau diunggah. Baris ini tidak masuk laporan pajak.",
      taxInvoiceReportHintOutput:
        "Faktur PPN keluaran yang masih harus dibuat di Core Tax, lalu diunggah.",
      taxInvoiceReportHintInput:
        "Faktur pajak pemasok yang masih harus diunggah.",
      taxInvoiceReportHintIncome:
        "Dokumen PPh dibayar di muka yang masih harus diunggah.",
      taxInvoiceReportHintOther:
        "Dokumen pajak lain yang masih harus diterbitkan atau diunggah.",
      taxInvoiceReportGeneratedOn: "Dibuat {date}",
      taxInvoiceReportColClient: "Klien",
      taxInvoiceReportColNpwp: "NPWP / ID",
      taxInvoiceReportColBillingFor: "Penagihan Untuk",
      taxInvoiceReportColDpp: "DPP",
      taxInvoiceReportColPpn: "PPN",
      taxInvoiceReportEmpty: "Tidak ada faktur pajak tertunda untuk pilihan ini.",
      taxInvoiceReportFileName: "Faktur-Pajak-Tertunda.pdf",
      taxInvoiceReportFileNameOutput: "PPN-Keluaran-Tertunda.pdf",
      taxInvoiceReportFileNameInput: "PPN-Masukan-Tertunda.pdf",
      taxInvoiceReportFileNameIncome: "PPh-Tertunda.pdf",
      taxInvoiceReportFileNameOther: "Pajak-Lain-Tertunda.pdf",
      taxReportTitle: "Laporan Pajak",
      taxReportHint:
        "PPN keluaran, PPN masukan, kredit PPN dibawa ke depan, PPh dibayar di muka, dan pajak lain untuk periode yang dipilih.",
      taxReportDate: "Tanggal",
      taxReportParty: "Pihak",
      taxReportDetail: "Rincian",
      taxReportDpp: "DPP",
      taxReportPpn: "PPN",
      taxReportAmount: "Jumlah",
      taxReportTotal: "Total",
      taxReportEmptyOutput: "Tidak ada PPN keluaran pada periode ini.",
      taxReportEmptyInput: "Tidak ada PPN masukan pada periode ini.",
      taxReportEmptyIncome: "Tidak ada PPh Badan dibayar di muka pada tahun ini.",
      ...
      outputDesc:
        "Faktur pajak klien yang sudah diterbitkan dan dibukukan bulan ini.",
      ...
      incomeTitle: "Kredit Pajak Penghasilan Badan",
      incomeDesc:
      ...
      incomeSourceProject: "Potongan Proyek",
      remittanceSourceProject: "PPh Proyek Yang Harus Disetor",
      openTaxInvoices: "Buka Faktur Pajak",
      openPurchases: "Buka Beban",
      ...
      supportingTaxDocument: "Dokumen Pajak",
      taxDocumentMissing: "Dokumen pajak belum diunggah.",
      taxInvoiceNumberPlaceholder: "cth. 010.000-26.00000001",
      taxInvoiceNumberHint:
        "Ketik Nomor Faktur Pajak yang tercetak di dokumen.",
      taxInvoiceNumberReading: "Membaca dokumen…",
      taxInvoiceNumberDetected:
        "Terisi dari dokumen. Periksa apakah cocok, lalu konfirmasi.",
      taxInvoiceNumberVerify:
        "Saya sudah memeriksa Nomor Faktur Pajak ini dengan dokumen.",
      fakturReady: "Terunggah",
      fakturPending: "Menunggu",
      emptyOutput: "Tidak Ada PPN Keluaran",
      emptyOutputDesc:
        "Tidak ada faktur pajak klien yang sudah diterbitkan pada bulan ini.",
      emptyInput: "Tidak Ada PPN Masukan",
      emptyInputDesc:
        "Tidak ada faktur pajak pemasok yang sudah diterbitkan pada bulan ini.",
      invoicePeriodFallback: "Periode Invoice",
      soldOffSale: "Sold Off",
      governmentClient: "Pemerintah",
      governmentPaidDirectlyTitle: "Dibayar Langsung Ke Pemerintah",
      governmentPaidDirectly:
        "Ini kontrak institusi pemerintah. Institusi klien menyetor pajak ini (PPN dan/atau PPh) langsung ke pemerintah. Relasi tidak menyetornya dari rekening perusahaan — anggap baris ini sudah dibayar.",
      columns: {
        client: "Klien",
        vendor: "Pemasok",
        date: "Tanggal",
    ...
    sales: {
      ...
      paidAtRequiredWithProof:
        "Isi tanggal uang masuk. Pendapatan penjualan dibukukan pada tanggal pembayaran, jadi bukti tanpa tanggal tidak bisa dicatat.",
      paymentProofRequiredWithDate:
        "Unggah bukti pembayaran untuk tanggal itu. Penjualan yang sudah dibayar butuh keduanya.",
      ...
      form: {
        ...
        warehouseCost: "Biaya Gudang",
        warehouseCostHint:
          "Harga modal stok di gudang. Setelah penjualan, stok berkurang. Jika penjualan dibatalkan, stok dikembalikan."
      }
    },
    financialReport: {
      title: "Laporan Keuangan",
      downloadReport: "Unduh Laporan Keuangan",
      reportHint:
        "Laba rugi untuk periode yang dipilih: pendapatan, harga pokok penjualan, Head Office, beban keuangan, dan pajak penghasilan badan, plus Piutang Usaha dan Utang Usaha.",
      reportTotal: "Total",
      reportDate: "Tanggal",
      reportSource: "Sumber",
      reportDetail: "Rincian",
      reportAmount: "Jumlah",
      reportEmptyMoneyIn: "Tidak ada baris pendapatan pada periode ini.",
      reportEmptyMoneyOut: "Tidak ada baris beban pada periode ini.",
      reportEmptyAr: "Tidak ada invoice klien yang belum dibayar.",
      reportEmptyAp: "Tidak ada tagihan pemasok yang belum dibayar.",
      reportEmptyFunding: "Tidak ada penarikan atau pengembalian pinjaman pada periode ini.",
      reportFunding: "Penarikan Dan Pengembalian Pinjaman",
      reportFundingHint:
        "Pendanaan, bukan pendapatan. Ditampilkan agar unduhan lengkap.",
      reportSources: {
        paidInvoice: "Invoice Dibayar",
        sale: "Penjualan",
        payrollManagement: "Payroll Management",
        parking: "Parkir",
        parkingFee: "Biaya Klien Parkir",
        parkingShare: "Bagi Hasil Parkir",
        parkingTax: "Pajak Parkir",
        parkingSetup: "Setup Parkir",
        depositKept: "Deposit Hangus",
        importIncome: "Pendapatan Selisih Kurs Impor",
        purchase: "Beban",
        inventory: "Inventaris",
        wages: "Gaji",
        overheadWages: "Upah Siaga Head Office",
        overheadStock: "Stok Internal Terpakai",
        thr: "THR",
        pettyCashTopUp: "Isi Ulang Kas Kecil",
        prepaidCardTopUp: "Isi Ulang Kartu Prabayar",
        prepaidVehicleCardTopUp: "Isi Ulang Kartu Kendaraan",
        prepaidOpenCardTopUp: "Isi Ulang Kartu Prabayar",
        prepaidCardReplacementFee: "Biaya Penggantian Kartu",
        prepaidCardReturn: "Pengembalian Kartu Hilang",
        transferFee: "Biaya Transfer",
        incident: "Beban Proyek",
        depositReturned: "Deposit Dikembalikan",
        importExpense: "Beban Selisih Kurs Impor",
        payrollAdjustment: "Penyesuaian Gaji",
        loanDraw: "Penarikan Pinjaman",
        loanReturn: "Pengembalian Pinjaman",
        cashWithdraw: "Ambil Tunai",
      ...
      filterBankCash: "Kas Tunai",
      transferReport: "Laporan Transfer",
      filterBankUnassigned: "Belum Ditentukan",
      rangeHint:
        "Pendapatan memakai periode kalender. Upah memakai jendela 16–15 untuk Staf Proyek dan 26–25 untuk Head Office, dicatat saat uang keluar. Aset tidak masuk laporan ini sampai dijual. Tagihan pemasok yang belum dibayar adalah Utang Usaha, bukan beban.",
      periodNet: "Laba Bersih",
      pnlTitle: "Laba Rugi",
      pnlHint:
        "Pendapatan pekerjaan adalah DPP. Harga pokok penjualan adalah bahan habis pakai dan upah di pekerjaan. Pembelian aset dan kendaraan tetap aset perusahaan. Pajak penghasilan badan mengikuti tarif PPh Badan di Tarif Pajak untuk setiap tanggal dalam periode.",
      pnlRevenue: "Pendapatan",
      pnlCostOfSales: "Harga Pokok Penjualan",
      pnlGrossProfit: "Laba Kotor",
      pnlOtherIncome: "Pendapatan Lain",
      pnlHeadOffice: "Head Office",
      pnlOperatingProfit: "Laba Usaha",
      pnlFinanceCosts: "Beban Keuangan",
      pnlProfitBeforeTax: "Laba Sebelum Pajak",
      pnlIncomeTax: "Pajak Penghasilan ({percent}%)",
      pnlIncomeTaxMixed: "Pajak Penghasilan",
      pnlNetProfit: "Laba Bersih",
      pnlClientTotal: "Total Klien",
      pnlSubcategoryTotal: "Total Jenis",
      pnlTreeTitle: "Pendapatan Per Pekerjaan",
      pnlTreeHint:
        "Setiap pekerjaan menampilkan pendapatan, harga pokok penjualan, dan laba kotor. Head Office berada setelah semua klien, bukan di dalam pekerjaan.",
      pnlEmptyTree: "Tidak ada pendapatan atau harga pokok penjualan pada periode ini.",
      pnlGroupContract: "Kontrak {name}",
      pnlGroupOneTime: "Satu Kali {name}",
      netPosition: "Posisi Bersih",
      netPositionHint:
        "Laba bersih dikurangi Utang Usaha. Penarikan pinjaman tetap di halaman Pinjaman. Itu pendanaan, bukan pendapatan.",
      ...
      companyMoneyOutHint:
        "Bahan habis pakai di pekerjaan, tagihan pemasok saat dibayar, Penggajian Internal, pengeluaran parkir, biaya Head Office, isi ulang Kas Kecil, isi ulang kartu prabayar, dan beban yang dibayar dari Kas Tunai. Membeli atau mengeluarkan aset bukan beban. Mengambil tunai dari bank bukan beban.",
      companyMoneyInCashHint:
        "Pendapatan klien tidak masuk ke Kas Tunai. Mengambil tunai dari bank menambah laci, bukan pendapatan.",
      companyMoneyOutCashHint:
        "Hanya beban yang dibayar dari Kas Tunai pada periode ini. Tunai yang belum dipakai tetap di Kas Tunai sampai dibelanjakan.",
      cashAtHand: "Kas Tunai",
      cashAtHandHint:
        "Uang tunai yang sudah diambil dari rekening perusahaan dan belum dipakai. Saldo ini tetap ada seperti rekening bank sampai Anda membayar pengeluaran dengan Tunai. Lokasi simpan tidak dicatat.",
      cashAtHandWithdraw: "Diambil Dari Bank",
      cashAtHandSpend: "Dibayar Dari Tunai",
      cashAtHandDeposit: "Dikembalikan Ke Bank",
      stockInWarehouse: "Nilai Persediaan",
      stockInWarehouseHint:
        "Nilai bahan habis pakai yang masih di gudang. Peralatan adalah aset perusahaan di mana pun berada, bukan biaya persediaan.",
      headOfficeOverhead: "Head Office",
      headOfficeOverheadPeriodHint:
        "Standby Wage Head Office, pembelian Internal yang dibayar periode ini, stok yang dipakai di Head Office atau Gudang Internal, dan selisih kurs impor.",
      ...
      jobHistoryTitle: "Pendapatan Per Pekerjaan",
      jobHistoryDesc:
        "Pekerjaan dikelompokkan menurut jenis, lalu klien. Laba kotor adalah pendapatan dikurangi harga pokok penjualan. Head Office tidak dibebankan ke klien.",
      sameDaySplitNote:
      ...
      totalProfit: "Laba Kotor",
      detail: {
        periodNet: "Rincian Laba Bersih",
        netPosition: "Rincian Posisi Bersih",
        moneyIn: "Rincian Pendapatan",
        moneyOut: "Rincian Harga Pokok Penjualan",
        ar: "Rincian Piutang Usaha",
        ap: "Rincian Utang Usaha",
        warehouse: "Rincian Nilai Persediaan",
        cashAtHand: "Rincian Kas Tunai",
        cashAtHandHelp:
          "Tunai yang belum dipakai tetap di sini seperti saldo bank. Pilih Kas Tunai pada Rekening Bank untuk melihat hanya laci ini. Membayar pengeluaran dengan tunai menguranginya dan mencatat beban itu dibayar dengan Tunai. Mengambil tunai bukan laba rugi sampai uang itu dipakai.",
        cashAtHandEmpty: "Belum ada kas tunai.",
        cashAtHandEmptyDesc:
          "Gunakan Ambil Tunai di Pengeluaran untuk menarik dari rekening perusahaan.",
        overhead: "Rincian Head Office",
        ...
        warehouseHelp:
          "Bahan habis pakai di gudang adalah aset sampai dikeluarkan ke pekerjaan. Peralatan tetap aset perusahaan saat dikeluarkan — itu hanya mencatat di mana aset itu berada.",
        ...
        moneyOutHelp:
          "Beban termasuk biaya Head Office, isi ulang Kas Kecil, isi ulang kartu prabayar, deposit karyawan yang dikembalikan, beban yang dibayar dari Kas Tunai, dan beban Head Office saat Kurs Bank impor lebih tinggi dari Kurs Pencatatan. Mengambil tunai dari bank bukan beban pada Semua Bank.",
        moneyInCashHelp:
          "Kas Tunai tidak menerima pendapatan klien. Mengambil tunai dari bank bukan pendapatan.",
        moneyOutCashHelp:
          "Hanya beban yang dibayar dengan Tunai pada periode ini. Tunai yang belum dipakai tetap di Kas Tunai dan bukan beban sampai dibelanjakan.",
        overheadHelp:
          "Standby Wage Head Office, pembelian Internal yang dibayar periode ini, stok yang dipakai situs Internal, dan selisih kurs impor yang dicatat ke Head Office.",
        depositsHelp:
        ...
        netPositionHelp:
          "Laba bersih dikurangi utang pemasok. Penarikan pinjaman bukan pendapatan. Piutang adalah yang masih terutang klien."
      },
      contractValueHint: "Jumlah harga kontrak proyek.",
      spendingHint:
        "Bahan habis pakai di pekerjaan dan hari CICO Penggajian Internal di sini. Peralatan yang dikeluarkan ke lokasi bukan biaya.",
      moneyIn: "Pendapatan",
      moneyInHint:
        "Jumlah rekonsiliasi yang disetujui, atau jumlah invoice, setelah pajak dikeluarkan dengan membagi.",
      moneyOut: "Harga Pokok Penjualan",
      moneyOutHint:
        "Bahan habis pakai, jasa yang ditagihkan ke pekerjaan, dan Penggajian Internal yang dialokasikan ke pekerjaan ini. Bukan peralatan.",
      moneyOutBreakdownTitle: "Rincian Harga Pokok Penjualan",
      moneyOutBreakdownDesc:
        "Bahan habis pakai di pekerjaan ini, jasa yang ditagihkan, belanja kas kecil, dan Penggajian Internal (upah harian × hari CICO lengkap). Peralatan yang dikeluarkan ke sini hanya lokasi.",
      inventoryOut: "Bahan Habis Pakai",
      jobPurchasesOut: "Jasa Dan Kas Kecil",
      parkingDealOut: "Kesepakatan Parkir",
      incidentsOut: "Insiden",
      wagesOut: "Gaji",
      moneyOutTotal: "Total Harga Pokok Penjualan",
      profit: "Laba Kotor",
      profitHint: "Pendapatan − Harga Pokok Penjualan",
      margin: "Margin",
      marginHint: "Laba Kotor ÷ Pendapatan",
      ...
      inventoryTitle: "Bahan Habis Pakai Terpakai",
      inventoryDesc:
        "Bahan habis pakai non-void yang dikeluarkan ke proyek ini. Peralatan yang dikeluarkan ke sini bukan biaya.",
      ...
      emptyInventory: "Belum Ada Bahan Habis Pakai",
      emptyInventoryDesc:
        "Bahan kimia dan bahan habis pakai yang dikeluarkan ke proyek ini muncul di sini sebagai harga pokok penjualan.",
      ...
      columns: {
        ...
        project: "Proyek",
        contractValue: "Nilai Kontrak",
        spending: "Harga Pokok Penjualan",
        moneyIn: "Pendapatan",
        costOfSales: "Harga Pokok Penjualan",
    ...
    thr: {
      title: "THR",
      downloadReport: "Unduh Laporan THR",
      reportTitle: "Laporan THR",
      reportHint:
    ...
    payslips: {
      title: "Slip Gaji",
      description:
        "Kehadiran bulanan, alasan pembayaran, potongan, dan Saldo Terutang Kepada Perusahaan.",
      directoryTitle: "Slip Gaji",
      directoryDesc:
        "Semua karyawan aktif. Buka nama untuk riwayat gaji bulanan. Saldo Terutang Kepada Perusahaan ditampilkan di setiap baris.",
      balanceDueTitle: "Karyawan",
      emptyBalance: "Tidak Ada Karyawan.",
      emptyMonths: "Belum Ada Riwayat Gaji Bulanan.",
      emptyMonth: "Tidak Ada Slip Gaji Untuk Bulan Ini.",
      openPayroll: "Buka Penggajian Internal",
      ...
      clickMonth: "Buka bulan ini",
      monthDetailTitle: "Slip Gaji",
      earnings: "Penghasilan",
      deductions: "Potongan",
      bpjsEmployee: "BPJS Karyawan",
      bpjsCompany: "BPJS Perusahaan",
      netPay: "Gaji Bersih",
      daysWorked: "Hari Kerja",
      preview: "Pratinjau",
      locked: "Terkunci",
    ...
    loans: {
      ...
      emptyDesc:
        "Daftarkan fasilitas bank atau pinjaman pribadi, lalu catat penarikan dan pengembalian di sini.",
      name: "Nama Pinjaman",
      namePlaceholder: "mis. Pinjaman Standby BCA",
      source: "Sumber Pinjaman",
      lenderName: "Pemberi Pinjaman",
      lenderNameHint: "Bank atau kreditur tempat uang ini berasal.",
      startDate: "Tanggal Mulai",
      notes: "Catatan",
      ...
      extendTermsChanged: "Apakah Bunga Atau Ketentuan Berubah?",
      extendTermsChangedHint:
        "Pilih Ya hanya jika plafon, suku bunga, atau perhitungan berubah. Jika tidak ada yang berubah, kita hanya memperpanjang jangka waktunya.",
      extendTermsUnchanged:
        "Plafon dan suku bunga tetap. Pinjaman diperpanjang satu tahun lagi.",
      ...
      variable: "Variabel",
      value: "Nilai",
      variablesTitle: "Variabel Perhitungan",
      variablesDesc:
        "Hitungan hari, suku bunga, dan metode untuk bunga, commitment fee, dan angsuran.",
      editVariables: "Ubah Variabel",
      editVariablesTitle: "Ubah Variabel Perhitungan",
      editVariablesDesc:
        "Perbarui hitungan hari, suku bunga, dan metode untuk fasilitas ini.",
      editVariablesSave: "Simpan Variabel",
      editVariablesFailed: "Tidak dapat menyimpan variabel ini.",
      commitmentFeeApplies: "Ada Commitment Fee",
    ...
    bpjs: {
      title: "BPJS",
      downloadReport: "Unduh Laporan BPJS",
      reportTitle: "Laporan BPJS",
      reportHint:
        "Setiap karyawan terdaftar BPJS Kesehatan dan BPJS Ketenagakerjaan, dengan bagian karyawan, tanggungan perusahaan, total, dan rincian program.",
      reportEmpty: "Tidak ada pendaftaran atau pembayaran BPJS pada periode ini.",
      reportTotal: "Total",
      reportEmployees: "Karyawan Terdaftar",
      reportHolding: "Holding Karyawan",
      description:
    ...
    pettyCash: {
      ...
      tabPetty: "Kas Kecil",
      tabPrepaid: "Kartu",
      tabVehicleCards: "Kartu Kendaraan",
      tabOpenCards: "Kartu Prabayar",
      prepaidCreate: "Tambah Kartu",
      prepaidCreateDesc:
        "Pilih Kartu Kendaraan atau Kartu Prabayar, masukkan nomor, lalu tetapkan sekarang atau biarkan Siaga.",
      prepaidCreateFailed: "Tidak dapat menyimpan kartu ini.",
      prepaidEmptyTitle: "Belum Ada Kartu",
      prepaidEmptyDesc:
        "Tambah kartu ke daftar. Isi ulang kartu apa pun di Pengeluaran → Kartu Prabayar.",
      prepaidSpend: "Catat Pengeluaran",
      prepaidSpendDesc: "Unggah nota BBM, tol, atau parkir.",
      prepaidSpendConfirm: "Debit Kartu",
      prepaidSpendFailed: "Tidak dapat mencatat pengeluaran kartu ini.",
      prepaidAddCard: "Tambah Kartu",
      cardManageDenied: "Hanya pemilik yang dapat menambah atau mengedit kartu.",
      totalTopUp: "Total Isi Ulang",
      totalSpend: "Total Belanja",
      netPosition: "Posisi Bersih",
      filterCard: "Kartu",
      filterAllCards: "Semua Kartu",
      filterMonth: "Bulan",
      filterYear: "Tahun",
      filterDay: "Hari",
      ...
      updateFailed: "Tidak dapat menyimpan kartu ini.",
      entriesEmpty: "Tidak Ada Aktivitas Kartu Pada Filter Ini.",
      cardEntriesEmpty: "Belum ada aktivitas pada kartu ini.",
      ...
      spendParking: "Parkir",
      spendOther: "Lainnya",
      kindVehicle: "Kartu Kendaraan",
      kindOpen: "Kartu Prabayar",
      cardType: "Jenis Kartu",
      personInCharge: "Penanggung Jawab",
      assignCard: "Tetapkan Kartu",
      assignCardDesc: "Tetapkan kartu Siaga ini ke kendaraan atau penanggung jawab.",
      reassignCard: "Ubah Penugasan",
      reassignCardDesc: "Kartu tetap aktif. Riwayat menyimpan nama lama dan baru.",
      returnToList: "Kembalikan Ke Daftar",
      returnToListConfirm: "Kembalikan kartu ini ke daftar sebagai Siaga? Sisa saldo tetap di kartu.",
      markDamaged: "Tandai Rusak",
      markDamagedDesc: "Belanja diblokir. Tetapkan kartu baru sekarang, atau biarkan kartu Rusak ini pada kendaraan atau orang yang sama.",
      assignNewNow: "Tetapkan Kartu Baru Sekarang",
      keepDamagedAssigned: "Tetap Pada Penugasan Ini",
      keepDamagedHint: "Kartu ini tetap Rusak pada kendaraan atau orang yang sama. Belanja tetap diblokir sampai kartu diganti.",
      replacementCard: "Kartu Siaga Yang Ditetapkan",
      cardReplaced: "Kartu Diganti",
      cardReplacedDesc: "Catat biaya penggantian setiap kali, lalu lanjutkan kartu ini atau pindahkan sisa ke kartu lain.",
      continueSameCard: "Kartu Yang Sama Dilanjutkan",
      moveLeftover: "Pindahkan Sisa Ke Kartu Lain",
      destinationCard: "Kartu Penerima Sisa",
      replacementFee: "Biaya Penggantian",
      feeFromLeftover: "Dari Sisa",
      feeFromBank: "Dari Bank Perusahaan",
      reportLost: "Hilang / Dicuri",
      reportLostDesc: "Tidak ada yang bisa dikembalikan dari bank. Sisa keluar dari kartu. Kendaraan atau orang tidak punya kartu sampai Anda menetapkan dari daftar.",
      ...
      misuseAmount: "Jumlah",
      misuseNote: "Catatan",
      lostLeftover: "Sisa Pada Kartu Ini",
      ...
      leaveStandby: "Biarkan Siaga",
      writtenOff: "Dihapusbukukan",
      writtenOffTitle: "Dihapusbukukan",
      writtenOffEmpty: "Belum Ada Penghapusbukuan",
      writtenOffEmptyDesc: "Sisa kartu hilang tampil di sini saat dihapusbukukan atau masih ditagih.",
      backToWrittenOff: "Kembali Ke Dihapusbukukan",
      backToList: "Kembali Ke Daftar Kartu",
      footedBy: "Ditanggung",
      footedByCompany: "Kantor Pusat",
      amountRecovered: "Jumlah Dipulihkan",
      amountLeft: "Jumlah Tersisa",
      installmentHistory: "Riwayat Cicilan",
      installmentTaken: "Dipotong Penggajian Internal",
      ...
      filterMovementWrittenOff: "Dihapusbukukan",
      ...
      proofRequired: "Unggah foto nota atau bukti.",
      fileTooLarge: "Berkas harus 10 MB atau lebih kecil.",
      fileTypeInvalid: "Unggah gambar atau PDF.",
      dateRequired: "Tanggal wajib diisi.",
      spendDescribeRequired: "Uraikan belanja Kas Kecil ini.",
      spendHolderRequired: "Pilih Kas Kecil karyawan mana yang dipakai untuk belanja ini.",
      spendOwnOnly: "Anda hanya dapat mencatat belanja dari Kas Kecil sendiri.",
      reverseSpend: "Batalkan Belanja",
      reverseRequired: "Pilih belanja yang akan dibatalkan.",
      reverseSpendOnly: "Hanya belanja yang dapat dibatalkan.",
      reversePostedOnly: "Hanya belanja yang sudah diposting yang dapat dibatalkan.",
      alreadyReversed: "Belanja ini sudah dibatalkan.",
      reversed: "Dibatalkan",
      employeeInvalid: "Pilih karyawan yang valid.",
      projectRequired: "Pilih proyek.",
      projectInvalid: "Pilih proyek yang valid.",
      clientRequired: "Pilih klien.",
      clientInvalid: "Pilih klien yang valid.",
      transferFromRequired: "Pilih Kas Kecil karyawan mana yang ditransfer.",
      transferSameEmployee: "Pilih karyawan lain yang menerima Kas Kecil ini.",
      transferNeedsPettyModule:
        "Penerima harus punya modul Kas Kecil untuk menerima transfer float.",
      transferInsufficient: "Saldo Kas Kecil tidak cukup untuk transfer sebesar itu.",
      amountInvalid: "Masukkan jumlah yang valid.",
      wageSelectRequired: "Pilih upah paruh waktu yang akan dibayar.",
      wageAlreadyPaid: "Upah ini sudah dibayar atau tidak menunggu pembayaran.",
      wagePayerSelf: "Upah ini milik Anda sendiri. Pemegang lain yang harus membayarnya.",
      wagePayerNotHolder:
        "Hanya Kas Kecil Anda sendiri yang dapat membayar upah ini, dan akun ini tidak terhubung ke pemegang Kas Kecil.",
      topUpOpenLabel: "Isi Ulang Kartu Prabayar {number}",
      topUpVehicleLabel: "Isi Ulang Kartu Kendaraan {number}",
      replacementFeeLabel: "Biaya Penggantian Kartu {number}",
      lostReturnLabel: "Pengembalian Kartu Hilang {number}",
      topUpHolderLabel: "Isi Ulang Kas Kecil · {name}",
      topUpHolderNote: "Isi ulang Kas Kecil",
      transferOutLabel: "Transfer Kas Kecil ke {name}",
      transferInLabel: "Transfer Kas Kecil dari {name}",
      paidFromLabel: "Dibayar dari {name}",
      cardKindRequired: "Pilih Kartu Kendaraan atau Kartu Prabayar.",
      cardRequired: "Pilih kartu.",
      cardNotFound: "Kartu tidak ditemukan.",
      standbyAssignOnly: "Hanya kartu Siaga yang dapat ditetapkan.",
      returnBeforeReassign: "Kembalikan kartu ke daftar sebelum menetapkannya lagi.",
      cardNotAssigned: "Kartu ini belum ditetapkan.",
      spendKindRequired: "Pilih keperluan nota ini.",
      amountPaidRequired: "Masukkan jumlah yang dibayar.",
      spendActiveOnly: "Belanja hanya boleh pada kartu Aktif.",
      openCardOtherOnly: "Kartu Prabayar hanya dapat mencatat Lainnya, dengan catatan.",
      otherNoteRequired: "Tambahkan catatan untuk belanja Lainnya ini.",
      odometerRequired: "Masukkan odometer saat ini dalam kilometer.",
      litresRequired: "Masukkan berapa litre yang diisi.",
      odometerWentBack: "Odometer tidak boleh lebih rendah dari pembacaan terakhir pada kendaraan ini.",
      damagedActiveOnly: "Hanya kartu Aktif yang dapat ditandai Rusak.",
      standbyAssignNow: "Pilih kartu Siaga untuk ditetapkan sekarang.",
      replacementNotFound: "Kartu pengganti tidak ditemukan.",
      sameTypeRequired: "Pilih kartu dengan jenis yang sama.",
      standbyRequired: "Pilih kartu Siaga.",
      vehicleCardNoVehicle: "Kartu Kendaraan ini belum punya kendaraan.",
      openCardNoPic: "Kartu Prabayar ini belum punya penanggung jawab.",
      feeNegative: "Biaya penggantian tidak boleh negatif.",
      bankForFee: "Pilih rekening bank perusahaan untuk biaya ini.",
      replacedDamagedOnly: "Kartu Diganti hanya tersedia saat kartu berstatus Rusak.",
      feeExceedsLeftover: "Biaya penggantian lebih besar dari sisa pada kartu ini.",
      destinationRequired: "Pilih kartu yang menerima sisa.",
      destinationNotFound: "Kartu tujuan tidak ditemukan.",
      destinationDifferent: "Pilih kartu lain, atau lanjutkan pada kartu ini.",
      cardNumberRetired: "Nomor kartu itu sudah dinonaktifkan.",
      assignReplacementVehicle: "Tetapkan kartu pengganti ke kendaraan terlebih dahulu.",
      assignReplacementPic: "Tetapkan kartu pengganti ke penanggung jawab terlebih dahulu.",
      recoveryMethodRequired: "Pilih cara sisa dipulihkan.",
      employeeCoverMethodRequired: "Pilih cara karyawan menanggung sisa ini.",
      coveringEmployeeRequired: "Pilih karyawan yang menanggung sisa ini.",
      returnBankRequired: "Pilih rekening bank perusahaan yang menerima pengembalian.",
      cardAlreadyRetired: "Kartu ini sudah dinonaktifkan.",
      payrollScheduleFailed: "Tidak dapat menjadwalkan pemulihan kartu pada Penggajian Internal.",
      misuseCardRequired: "Pilih kartu prabayar.",
      misuseEmployeeRequired: "Pilih karyawan yang menyalahgunakan kartu.",
      misuseAmountRequired: "Masukkan jumlah yang disalahgunakan.",
      prepaidCardMissing: "Kartu prabayar tidak ditemukan.",
      writtenOffCompany: "Dihapusbukukan · perusahaan",
      writtenOffNamed: "Dihapusbukukan · {name}",
      transferToCardLabel: "Transfer ke Kartu {number}",
      transferFromCardLabel: "Transfer dari Kartu {number}",
      proof: "Nota / Bukti",
      ...
      chargeTypeHeadOffice: "Kantor Pusat",
      chargeTypeRequired: "Pilih Proyek, Klien, atau Kantor Pusat.",
      chargeTypeHeadOfficeHint:
        "Belanja ini ke Kantor Pusat, bukan ke pekerjaan. Kas kecil hanya float — setiap belanja tetap harus punya tujuan.",
      client: "Klien",
      ...
      kind: {
        ...
        REPLACEMENT_FEE: "Biaya Penggantian Kartu",
    ...
    payroll: {
      ...
      periodWindowRange: "Periode gaji: {range}.",
      runProjectCycle: "Staf Proyek (16–15)",
      runHeadOffice: "Head Office (26–25)",
      periodPreview: "Preview — run ini dibayar tanggal 16.",
      periodReconciled: "Dibayar tanggal 16.",
      periodPreviewHeadOffice: "Preview — run ini dibayar tanggal 25.",
      periodReconciledHeadOffice: "Dibayar tanggal 25.",
      ...
      employeeBalanceWithCompany: "Saldo Dengan Perusahaan",
      tableTitle: "Detail Penggajian",
      tableDesc:
        "Staf RGS aktif dan siapa pun dengan CICO lengkap di periode ini. Hari kerja = 9 jam atau lebih (18 jam pada shift ganda yang ditugaskan). Shift di atas 26 yang ditanggung gaji pokok ditandai di sini dan hanya dibayar jika Anda menambah Lembur. Hari di bawah jam tetap tidak dibayar sampai Bayar Penuh atau jumlah kustom. Bendera terlambat atau pulang awal tidak mengubah gaji di sini.",
      shiftsAgainstBase: "{worked} dari {base} shift",
      doubleShiftCount: "{count} shift ganda",
      surplusShifts: "{count} shift surplus — tambah lembur untuk membayarnya",
      suggestedOvertime:
        "Usulan lembur {amount} ({count} × upah harian). Tambah baris Lembur sebelum Generate Excel.",
      surplusShiftUnpaid: "Surplus — tambah lembur",
      ...
      requestUnlockDesc:
        "Jelaskan dengan tepat apa yang harus diperbaiki. Periode tetap terkunci sampai pemilik menyetujui permintaan ini di Persetujuan.",
      submitUnlockRequest: "Kirim Permintaan Buka Kunci",
      withdrawUnlockRequest: "Tarik Permintaan",
      unlockRequestPending: "Buka Kunci Diminta",
      unlockUnknownRequester: "Pengguna Tidak Diketahui",
      unlockPending: "Buka kunci diminta oleh {name}. Alasan: {reason}",
      unlockPeriod: "Buka Periode",
      unlockPeriodDesc:
        "Membuka kunci hanya untuk pemilik. Setelah dibuka, potongan bisa diubah dan periode ini bisa dibuat ulang, dan perubahan absensi akan mengubah gaji lagi sampai Anda generate. Setiap perubahan setelah ini dicatat permanen beserta nama Anda.",
      unlockReason: "Alasan Buka Kunci",
      lockConfirmTitle: "Kunci Periode Payroll Ini",
      lockConfirmBody:
        "Apakah setiap hari dan setiap jumlah sudah benar? Generate akan mengunci {period}. Setelah itu tidak ada yang bisa mengubahnya — Kantor Pusat maupun Direktur. Hanya pemilik yang dapat membuka kunci, dan setiap perubahan setelahnya dicatat permanen beserta nama pelakunya.",
      lockConfirmAction: "Generate Dan Kunci",
      alreadyLockedNote: "Periode ini terkunci. Generate lagi tidak mengubahnya.",
      changeHistory: "Riwayat Perubahan",
      changeHistoryDesc:
        "Catatan permanen untuk periode ini. Entri ini tidak pernah dihapus.",
      changeHistoryEmpty: "Belum ada perubahan pada periode ini.",
      changeActions: {
        PAYROLL_LOCKED: "Dikunci",
        PAYROLL_UNLOCK_REQUESTED: "Buka Kunci Diminta",
        PAYROLL_UNLOCK_CANCELLED: "Permintaan Buka Kunci Ditarik",
        PAYROLL_UNLOCK_APPROVED: "Buka Kunci Disetujui",
        PAYROLL_UNLOCK_REJECTED: "Buka Kunci Ditolak",
        PAYROLL_UNLOCKED: "Dibuka",
        PAYROLL_EMPLOYEE_ADDED: "Karyawan Ditambah Saat Dibuat Ulang",
        PAYROLL_EMPLOYEE_REMOVED: "Karyawan Dihapus Saat Dibuat Ulang",
        PAYROLL_EMPLOYEE_CHANGED: "Gaji Karyawan Diubah",
        PAYROLL_LINE_ADDED: "Baris Ditambah",
        PAYROLL_LINE_REMOVED: "Baris Dihapus",
        PAYROLL_DAY_PAY_SET: "Upah Harian Diatur"
      },
      ...
      errors: {
        ...
        periodLocked:
          "Periode payroll ini terkunci. Ajukan permintaan buka kunci; hanya pemilik yang dapat menyetujuinya.",
        ...
        overtimeOmOnly:
          "Hanya Operational Manager atau pemilik yang dapat menambah lembur.",
        unlockHoOnly:
          "Hanya pemilik yang dapat membuka periode payroll yang terkunci. Kantor Pusat dan Direktur tidak bisa.",
        ...
        unlockRequestLockedOnly:
          "Hanya periode payroll yang terkunci yang dapat diajukan untuk dibuka.",
        unlockRequestAlreadyPending:
          "Permintaan buka kunci untuk periode payroll ini sudah menunggu.",
        unlockRequestNotFound:
          "Permintaan buka kunci ini tidak ditemukan atau sudah tidak tersedia.",
        unlockRequestAlreadyOpen:
          "Periode payroll ini sudah terbuka sehingga permintaan tidak dapat disetujui.",
        unlockRequestFailed:
          "Tidak dapat mengirim permintaan buka kunci payroll.",
        unlockCancelFailed:
          "Tidak dapat menarik permintaan buka kunci payroll.",
        unlockDecisionFailed:
          "Tidak dapat memutuskan permintaan buka kunci payroll.",
        unlockOwnerApprovalOnly:
          "Hanya pemilik yang dapat menyetujui atau menolak permintaan buka kunci payroll.",
        ...
        exportFailed: "Tidak dapat membuat PDF Internal Payroll.",
        lockConfirmRequired:
          "Konfirmasi bahwa setiap hari dan setiap jumlah sudah benar sebelum generate.",
        periodNotFinished:
          "Periode payroll ini belum selesai. Tinjau dan generate hanya setelah hari penutupan periode gaji.",
        bankTransferFailed: "Tidak dapat membuat berkas transfer bank.",
        bankTransferBlockedTitle: "Transfer Bank Diblokir",
        bankTransferBlockedDesc:
          "Lengkapi detail bank berikut di data karyawan, lalu buat berkasnya lagi."
      }
    },
    reconciliation: {
      title: "Rekonsiliasi",
      ...
      clientPendingHelp:
        "Setujui untuk menerbitkan invoice, atau revisi dengan alasan, jumlah yang disesuaikan, dan bukti opsional untuk Head Office.",
      ...
      revisionProof: "Bukti pendukung klien",
      ...
      noPortalSentConfirm: "Saya Mengerti",
      noPortalSentStepDownload:
        "Unduh laporan progres dan kirim ke klien di luar ERP.",
      noPortalSentStepReply:
        "Tunggu jawaban mereka. Jika mereka minta perubahan, selesaikan dulu di luar sistem.",
      noPortalSentStepApprove:
        "Catat Disetujui atau Direvisi di sini. Head Office yang menyetujui — klien tidak bisa melakukannya di sistem.",
      noPortalSentStepInvoice:
        "Setelah disetujui, buat invoice, unduh, lalu kirim ke klien.",
      noPortalSentStepPayment:
        "Saat mereka bayar, mereka kirim bukti. Unggah bukti itu agar invoice bisa menuju Jatuh Tempo / lunas.",
      noPortalSentStepTax:
        "Unggah faktur pajak yang mereka kirim — PPN, atau PPN dan PPh, sesuai pajak proyek.",
      clientActionTitle: "Review Anda",
      clientActionHelp:
        "Tinjau laporan, lalu pilih Setujui atau Revisi.",
      chooseApprove: "Setujui",
      chooseRevise: "Revisi",
      chooseApproveHint: "Terbitkan invoice sesuai jumlah yang disepakati.",
      chooseReviseHint: "Minta perubahan dan kirim jumlah yang disesuaikan.",
      approveCardHelp: "Setujui laporan ini untuk menerbitkan invoice.",
      approveProposedHelp:
        "Setujui jumlah usulan Head Office sebesar {amount}. Invoice akan diterbitkan.",
      hoChooseApproveHint: "Terima jumlah yang diminta klien dan terbitkan invoice.",
      hoChooseReviseHint: "Tolak permintaan dan usulkan jumlah baru.",
      ...
      filterAllMonths: "Semua Bulan",
      filterApply: "Terapkan",
      approvedCardHint: "Laporan dan invoice yang disetujui untuk periode terpilih.",
      revisedCardHint: "Revisi yang menunggu Kantor Pusat, plus riwayat revisi.",
      offlineReviewTitle: "Catat Respons Klien",
      offlineReviewHelp:
        "Klien ini tidak punya login portal. Unduh laporan, kirim sendiri, lalu catat keputusan mereka.",
      offlineApproved: "Disetujui",
      offlineRevised: "Direvisi",
      offlineApprovedHint: "Invoice sesuai nilai kontrak / yang diajukan.",
      offlineRevisedHint: "Mereka sudah setuju jumlah baru di luar sistem. Isi alasan dan angka baru.",
      offlineReason: "Alasan Direvisi",
      offlineReasonPlaceholder: "Jelaskan perubahan yang disepakati…",
      offlineNewAmount: "Jumlah Invoice Revisi",
      offlineSubmit: "Catat Dan Buat Invoice",
      offlineSubmitting: "Mencatat…",
      offlineFailed: "Tidak dapat mencatat respons klien.",
    ...
    cico: {
      ...
      errors: {
        ...
        onLeaveBlocked:
          "Tidak ada check-in pada hari cuti. Check-out sesi kemarin jika masih terbuka, lalu check-in lagi sehari setelah cuti berakhir.",
        cicoExemptBlocked:
    ...
    shifts: {
      ...
      assignedStaffTitle: "Staf Ditugaskan",
    ...
    teams: {
      ...
      addTeam: "Tambah Tim",
      assignMembersOnCreate: "Tugaskan Karyawan",
      assignEquipmentOnCreate: "Tugaskan Peralatan",
      noEligibleMembers: "Belum ada karyawan yang bisa ditugaskan.",
      noEquipment: "Belum ada unit peralatan yang bisa ditugaskan.",
      editTeam: "Ubah Tim",
      deleteTeam: "Hapus Tim",
      members: "Anggota",
      addMember: "Tambah Anggota",
      assignEquipment: "Tugaskan Peralatan",
      assignEquipmentHint:
        "Peralatan yang ditugaskan ke tim mengikuti tim ke setiap pekerjaan.",
      assignEquipmentSearch: "Cari Peralatan",
      assignEquipmentEmptySearch: "Tidak Ada Peralatan Yang Cocok.",
      assignEquipmentEmpty: "Tidak ada unit peralatan yang tersedia.",
      assignEquipmentSave: "Simpan Peralatan",
      assetCode: "Kode Aset",
      item: "Item",
      assigned: "Ditugaskan",
      ...
      emptyEligibleFiltered: "Tidak ada karyawan yang dapat ditambahkan di departemen ini.",
      emptyEligibleSearch: "Tidak ada karyawan yang cocok dengan pencarian ini.",
    ...
    approvals: {
      ...
      payrollUnlockSection: "Buka Kunci Payroll Internal",
      payrollUnlockSectionDesc:
        "Khusus pemilik. Persetujuan membuka kembali periode; setiap perubahan karyawan dan jumlah setelahnya tetap ada di Riwayat Perubahan permanen.",
      emptyPayrollUnlockTitle: "Tidak Ada Permintaan Buka Kunci Payroll",
      emptyPayrollUnlockDescription:
        "Tidak ada periode Payroll Internal terkunci yang menunggu untuk dibuka kembali.",
      payrollUnlockRequestedBy: "Diminta oleh {name} pada {date}",
      payrollUnlockDecisionNote: "Catatan Keputusan (Opsional)",
      payrollUnlockApprove: "Setujui Dan Buka",
      payrollUnlockReject: "Tolak Permintaan",
    ...
    inventory: {
      ...
      quantityExceedsStock:
        "Stok tersedia hanya {available} {unit}. Penjualan tidak boleh melebihi stok yang ada.",
      ...
      soldOffSelectAssetsRequired:
        "Pilih unit atau plat nomor yang dijual.",
      leasePayoff: "Pelunasan Sewa",
      leasePayoffHint:
        "{plate} masih menyisakan {remaining} pada sewa. Masukkan pelunasan bank.",
      leasePayoffRequired: "Masukkan pelunasan sewa untuk {plate}.",
      leaseSettlementPaidAt: "Tanggal Bayar Pelunasan Sewa",
      leaseSettlementBank: "Bank Pembayar",
      leaseSettlementProof: "Bukti Pelunasan Sewa",
      leaseSettlementHint:
        "Tanggal uang pelunasan dan biaya pengakhiran dini keluar dari rekening kita. Terpisah dari penjualan ke pembeli.",
      leaseSettlementRequired:
        "Isi tanggal bayar, bank pembayar, dan bukti untuk pelunasan sewa dan biaya pengakhiran dini.",
      earlyTermination: "Pengakhiran Dini",
      earlyTerminationHint:
        "Biaya pengakhiran dini dari bank untuk penjualan ini. Isi 0 jika bank tidak menagih.",
      ...
      buyerIdNumberInvalid:
        "Isi NIK 16 digit atau nomor paspor (6–12 huruf dan angka).",
      ...
      factoryReturn: {
        ...
        sendDesc:
          "Kirim kotak gudang atau unit berkode. Pabrik lalu Refund (bayar, unit hilang), Replace (stok baru tanpa kode, kode lama dihapus), atau Repair (unit berkode yang sama kembali dengan kode yang sama). Catat refund saat uang masuk rekening perusahaan.",
        ...
        refundBankRequired: "Pilih rekening perusahaan yang menerima refund.",
        refundBank: "Bank Penerima",
        ...
        recordRefundDesc:
          "Pabrik menyimpan unit ini. Kode aset lama dihapus. Stok tetap berkurang. Refund dicatat pada bank yang dipilih.",
        ...
        newHint:
          "{available} unit tersegel tersedia. Repair dan Replace masuk sebagai stok baru tanpa kode. Refund tidak mengembalikan stok.",
        issuedHint:
          "Pilih unit berkode. Repair memakai kode yang sama di Head Office. Replace datang sebagai stok baru tanpa kode; kode lama dihapus. Refund menghapus kode dan mencatat uangnya.",
        productHint:
          "Pengembalian yang masih menunggu menampilkan Catat Refund, Konfirmasi Diperbaiki, dan Pengganti Diterima.",
      ...
      form: {
        ...
        selectItemTypeToShowStock: "Pilih Jenis Item Untuk Menampilkan Stok.",
        quantity: "Kuantitas",
        notes: "Catatan",
        ...
        buyerIdNumberPlaceholder: "NIK 16 Digit Atau Nomor Paspor",
        ...
        soldOffVehicleHint:
          "Pilih plat nomor. Mobil sewa yang belum lunas wajib isi pelunasan dan biaya pengakhiran dini, dibayar dari bank penjualan.",
        soldOffAssets: "Aset Peralatan",
        soldOffPlates: "Plat Nomor",
        ...
        soldOffPlatesHint:
          "Wajib. Pilih plat. Menjual mobil sewa yang belum lunas mencatat pelunasan dan biaya pengakhiran dini dari bank penjualan.",
    ...
    itemCatalog: {
      ...
      stats: {
        ...
        inactiveTitle: "Item Nonaktif",
        inactiveSubtitle: "Disembunyikan dari pembelian baru",
    ...
    companyDetails: {
      ...
      sections: {
        ...
        tax: "Pajak",
        government: "Pembayaran Pemerintah",
        governmentHint:
      ...
      form: {
        ...
        bpjsKesehatanVa: "Rekening Virtual BPJS Kesehatan",
        bpjsKetenagakerjaanVa: "Rekening Virtual BPJS Ketenagakerjaan",
        bpjsVaHint:
          "Mengisi otomatis Tambah Pengeluaran saat membayar program itu. Membayar tagihan juga menyimpan nomor yang dipakai.",
        bankName: "Nama Bank",
        bankAccountNumber: "Nomor Rekening",
    ...
    systemGuide: {
      ...
      forClient: "Panduan Sistem Klien",
  ...
  modules: {
    ...
    pettyCashPrepaid: "Kartu",
    attendance: "Laporan Kehadiran",
    shifts: "Shift",
    leaves: "Izin & Sakit",
    approvals: "Persetujuan",
    approvalsLeaves: "Izin & Sakit",
    approvalsMaterialRequests: "Material",
    approvalsWarehouseReturns: "Pengembalian Barang",
    approvalsPayrollUnlock: "Buka Payroll",
