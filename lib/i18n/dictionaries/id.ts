...
export const id = {
  ...
  pages: {
    ...
    billing: {
      ...
      prepaidCardHint:
        "Isi ulang ini menambah saldo kartu. Kartu Kendaraan tetap di Kendaraan. Kartu Terbuka adalah Kantor Pusat.",
      purchaseCategoryOpenCard: "Kartu Terbuka",
      ...
      purchaseCategoryHint:
        "Produk menjadi stok gudang. Kendaraan dibeli di dalam negeri dan dicatat di Inventaris → Kendaraan. Isi ulang Kartu Kendaraan lewat Kendaraan → Kartu Prabayar. Isi ulang Kartu Terbuka di Kartu Terbuka. Jasa, Kas Kecil, Pemerintah, Pinjaman, dan Pembayaran Karyawan bukan stok.",
    ...
    financialReport: {
      ...
      reportSources: {
        ...
        prepaidOpenCardTopUp: "Isi Ulang Kartu Terbuka",
    ...
    pettyCash: {
      ...
      tabOpenCards: "Kartu Terbuka",
      prepaidCreate: "Tambah Kartu",
      prepaidCreateDesc:
        "Pilih Kartu Kendaraan atau Kartu Terbuka, masukkan nomor, lalu tetapkan sekarang atau biarkan Siaga.",
      prepaidCreateFailed: "Tidak dapat menyimpan kartu ini.",
      prepaidEmptyTitle: "Belum Ada Kartu",
      prepaidEmptyDesc:
        "Tambah kartu ke daftar. Isi ulang Kartu Kendaraan di Pengeluaran → Kendaraan → Kartu Prabayar, atau Kartu Terbuka di Pengeluaran → Kartu Terbuka.",
      ...
      cardManageDenied: "Hanya pemilik yang dapat menambah atau mengedit kartu prabayar.",
      ...
      topUpOpenLabel: "Isi Ulang Kartu Terbuka {number}",
      ...
      cardKindRequired: "Pilih Kartu Kendaraan atau Kartu Terbuka.",
      ...
      openCardOtherOnly: "Kartu Terbuka hanya dapat mencatat Lainnya, dengan catatan.",
      ...
      openCardNoPic: "Kartu Terbuka ini belum punya penanggung jawab.",
